...
public class dateChoose extends JPanel {
    ...
    public static dateChoose getInstance() {
        return new dateChoose();
    }

    public static dateChoose getInstance(Date date) {
        return new dateChoose(date);
    }

    public static dateChoose getInstance(String format) {
        return new dateChoose(format);
    }

    public static dateChoose getInstance(Date date, String format) {
        return new dateChoose(date, format);
    }
    ...
    private dateChoose(Date date) {
        this(date, "yyyy年MM月dd日");
    }

    private dateChoose(String format) {
        this(new Date(), format);
    }

    private dateChoose(Date date, String format) {
        initDate = date;
